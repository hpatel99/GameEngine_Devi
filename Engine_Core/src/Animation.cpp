...
void Animation::PushDataToSkeleton()
{
...
void Animation::SetSpeed(float inspeed)
{
	this->speed = inspeed;
}
...
void Animation::privProcessGPUanim(Frame_Bucket * pA, Frame_Bucket * pB, float t_)
{
	//t is lerp factor
	////////////////////////
		//Computer Shader 1
...
void Animation::privProcessCPUanim(Frame_Bucket * pA, Frame_Bucket * pB, float t_)
{
#if 0
...
void Animation::AddClip(Clip * inClip)
{
	if(this->pClipHead == 0)
	{
		pClipHead = inClip;
